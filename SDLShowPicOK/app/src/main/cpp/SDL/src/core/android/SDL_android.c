...
#define JNI_METHOD_SDL(x)		Java_com_tzh_wifi_video_capture_SDLActivity_##x    //用于保存一个接口
#define JNI_METHOD_SDLINPUT(x)		Java_com_tzh_wifi_video_capture_SDLInputConnection_##x    //用于保存一个接口
...
/* Drop file */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeDropFile)(
...
/* Resize */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeResize)(
                                    JNIEnv* env, jclass jcls,
...
/* Paddown */
JNIEXPORT jint JNICALL JNI_METHOD_SDL(onNativePadDown)(
                                    JNIEnv* env, jclass jcls,
...
/* Padup */
JNIEXPORT jint JNICALL JNI_METHOD_SDL(onNativePadUp)(
                                   JNIEnv* env, jclass jcls,
                                   jint device_id, jint keycode)
{
...
/* Joy */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeJoy)(
                                    JNIEnv* env, jclass jcls,
...
/* POV Hat */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeHat)(
                                    JNIEnv* env, jclass jcls,
...
JNIEXPORT jint JNICALL JNI_METHOD_SDL(nativeAddJoystick)(
    JNIEnv* env, jclass jcls,
...
JNIEXPORT jint JNICALL JNI_METHOD_SDL(nativeRemoveJoystick)(
...
/* Surface Created */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeSurfaceChanged)(JNIEnv* env, jclass jcls)
{
    SDL_WindowData *data;
...
/* Surface Destroyed */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeSurfaceDestroyed)(JNIEnv* env, jclass jcls)
{
...
/* Keydown */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeKeyDown)(
...
/* Keyup */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeKeyUp)(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
/* Keyboard Focus Lost */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeKeyboardFocusLost)(
                                    JNIEnv* env, jclass jcls)
{
...
/* Touch */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeTouch)(
                                    JNIEnv* env, jclass jcls,
...
/* Mouse */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeMouse)(
                                    JNIEnv* env, jclass jcls,
...
/* Accelerometer */
JNIEXPORT void JNICALL JNI_METHOD_SDL(onNativeAccel)(
                                    JNIEnv* env, jclass jcls,
...
/* Low memory */
JNIEXPORT void JNICALL JNI_METHOD_SDL(nativeLowMemory)(
...
/* Quit */
JNIEXPORT void JNICALL JNI_METHOD_SDL(nativeQuit)(
                                    JNIEnv* env, jclass cls)
{
...
/* Pause */
JNIEXPORT void JNICALL JNI_METHOD_SDL(nativePause)(
                                    JNIEnv* env, jclass cls)
{
...
/* Resume */
JNIEXPORT void JNICALL JNI_METHOD_SDL(nativeResume)(
                                    JNIEnv* env, jclass cls)
{
...
JNIEXPORT void JNICALL JNI_METHOD_SDLINPUT(nativeCommitText)(
                                    JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL JNI_METHOD_SDLINPUT(nativeSetComposingText)(
                                    JNIEnv* env, jclass cls,
                                    jstring text, jint newCursorPosition)
{
    const char *utftext = (*env)->GetStringUTFChars(env, text, NULL);
...
JNIEXPORT jstring JNICALL JNI_METHOD_SDL(nativeGetHint)(JNIEnv* env, jclass cls, jstring name) {
